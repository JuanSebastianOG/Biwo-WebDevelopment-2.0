...
const RightNavBarEdi = ({ open , handle }) => {
...
const signOutUser = () =>{
    ...
    return (
        <BurgerNavBar open={open}  onClick={handle} >
            <StyledLink to="/edAdminPagos" >
                <h1>Pagos Edificio</h1>
            </StyledLink>
            <hr />
            <StyledLink to="/edAdminResidentes" >
                <h1>Mis Residentes</h1>
            </StyledLink>
            <hr />
            <StyledLink to="/edAdminReservas"  >
